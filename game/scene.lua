...
function scene.resetStuff(forTime)
  ...
  clearRules()
  parseRules()
  --bugfix for text like dittos/this that need a second parse to form (since they rely on base rules being applied and are checked at the wrong timing otherwise)
