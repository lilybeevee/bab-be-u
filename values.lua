...
selector_grid_contents = {
  ...
  -- page 4: characters and special objects
  {
    ...
    "skul","txt_skul","beeee","txt_beeee","gul","txt_gul","kva","txt_kva","bunmy","txt_bunmy","ballt","txt_ballt",0,0,"notnat","txt_notnat","oat","txt_oat",
    ...
    "kapa","txt_kapa","urei","txt_urei","ryugon","txt_ryugon","viruse","txt_viruse","slog","txt_slog",0,0,0,0,0,0,0,0,
    "os","txt_os","hors","txt_hors","mimi","txt_mimi","err","txt_err","scorpino","txt_scorpino",0,0,0,0,0,0,0,0,
  },
  ...
  -- page 6: more inanimate objects
  {
    ...
    "colect","txt_colect","zig","txt_zig","pixl","txt_pixl","prop","txt_prop","qb","txt_qb","panlie","txt_panlie","cheez","txt_cheez","nuzt","txt_nuzt",0,0,
  ...
  -- page 7: properties, verbs and conditions
  {
    ...
    "txt_diag","txt_ortho","txt_gomyway","txt_n'tify","txt_ify",0,0,0,0,0,0,0,0,"txt_that","txt_thatbe","txt_thatgot","txt_meow","txt_beside",
